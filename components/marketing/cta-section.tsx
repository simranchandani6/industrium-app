...
export function CtaSection() {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#16202a_0%,#102b30_45%,#0d8578_100%)] py-24 lg:py-32">
      {/* ── Decorative background ───────────────────────────────── */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-0">
        {/* Glowing orbs */}
        <div className="absolute -left-32 top-0 h-96 w-96 rounded-full bg-accent/20 blur-3xl" />
        <div className="absolute -right-32 bottom-0 h-96 w-96 rounded-full bg-teal/25 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center lg:px-8">
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/register"
            className="group inline-flex items-center gap-2 rounded-full bg-accent px-8 py-4 text-sm font-bold text-ink shadow-xl shadow-black/20 transition hover:scale-[1.03] hover:bg-accent/90 hover:shadow-2xl hover:shadow-black/25"
          >
